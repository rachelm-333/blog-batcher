...
import { LayoutDashboard, LogOut, PanelLeft, Users, Calendar, Settings, FileText, Puzzle, Pencil, BarChart2, HelpCircle, Shield, CreditCard, Zap } from "lucide-react";
...
const menuItems = [
  ...
  { icon: Zap, label: "Free Trial", path: "/free-trial" },
];
