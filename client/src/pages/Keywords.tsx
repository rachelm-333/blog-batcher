                    ...
                    <div style={{ display:"flex", alignItems:"center", gap:6 }}>
                      ...
                      <input
                        ...
                        onBlur={(e) => {
                          ...
                          const current = ((kw as { plannedTitle?: string | null }).plannedTitle ?? "").trim();
                          if (v && v !== current) updatePlannedTitle.mutate({ businessId, articleNodeId: kw.articleNodeId, title: v });
                        }}
                      />
                    </div>
                  </td>
